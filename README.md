...
To ensure the website works correctly, your folder structure must look like this:

```text
ValentinesProject/
├── valentine.html           # The main HTML file
├── Helpless from HAMILTON.mp3 # Your background music file
├── style/
│   └── style.css            
└── pics/                    # Folder containing your photos
    ├── image1.jpeg
    ├── image2.jpeg
    ├── image3.jpeg
    └── ...
...
🎨 Technologies Used
* HTML5 - Structure
* CSS3 - Animations, Gradients, and Glassmorphism
* JavaScript (ES6) - Logic and DOM Manipulation
* Canvas Confetti - Celebration effect library

❤️ Credits
Confetti animation by catdad/canvas-confetti.
